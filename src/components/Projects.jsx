        ...
        projectItems: [
            {
                ...
                description: "I contributed to designing and developing the Digital Front Door, a well-designed and user-friendly web application that empowered users in their healthcare journey. " +
                ...
                tags: ["Javascript", "Typescript", "React", "Strapi", "Python", "Git", "Docker", "AWS", "Grafana"]
            },
            {
                logo: obsLogo,
                ariaLabel: "orange business services",
                title: "Sept 2016 - Sept 2019 | Rennes, France",
                description: "I contributed to designing and developing the Flux Vision client web portal, built using JHipster, a full-stack development platform. " +
        ...
        projectItems: [
            {
                ...
                title: "My TODO list",
                description: "This project is a full stack web application which I built as a practice of learning : Node.js, Express, MongoDB and Mongoose. " +
                ...
                tags: ["Typescript", "React", "MUI", "Redux", "Node.js", "Express", "MongoDB", "Mongoose", "NoSQL", "Restful API"],
            },
            {
                logo: themealrecipe,
                ariaLabel: "The meal recipe database",
                title: "The meal recipe database",
                description: "This web application, powered by TheMealDB API, lets users search for their favorite recipes. It also serves as a training project, showcasing the use of React, Redux, Redux Toolkit, Redux Thunk, and React Router.",
            ...
            },
            {
                ...
                description: "This project features a Strapi-powered backend, where admin users can define a collection of questions and possible answers through the Strapi Admin Panel. " +
